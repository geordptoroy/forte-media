...
// Valor sentinela para representar "todos" (Radix Select não aceita value="")
const ALL_VALUE = "all";
...
export const AdFilters: React.FC<AdFiltersProps> = ({
  ...
  const handleSelectChange = (key: string, value: string) => {
    // Converte o sentinela "all" de volta para string vazia no estado interno
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="space-y-2">
          ...
          <Select
            value={filters.score_min || ALL_VALUE}
            onValueChange={(value) => handleSelectChange('score_min', value)}
          >
            <SelectTrigger className="input-premium">
              <SelectValue placeholder="Todos os níveis" />
            </SelectTrigger>
            <SelectContent className="bg-black border-white/10">
              <SelectItem value={ALL_VALUE}>Todos os níveis</SelectItem>
        ...
        <div className="space-y-2">
          ...
          <Select
            value={filters.media_type || ALL_VALUE}
          ...
          >
            ...
            <SelectContent className="bg-black border-white/10">
              <SelectItem value={ALL_VALUE}>Todos os formatos</SelectItem>
