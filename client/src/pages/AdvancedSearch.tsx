    ...
    <DashboardLayout>
      <div className="space-y-8">
        <PageHeader
          ...
          subtitle="Filtros granulares para encontrar exatamente o que você precisa."
        />
        ...
        <Card className="bg-white/[0.02] border-white/5 p-6 rounded-[2rem]">
          <div className="flex gap-4">
            <div className="flex-1 relative">
              ...
              <Input
                placeholder="Palavras-chave, domínios ou nomes de páginas..."
                value={keywords}
          ...
          <AnimatePresence mode="wait">
            {isSearching ? (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col items-center justify-center py-32 gap-4">
                ...
                <p className="text-sm text-gray-600 font-black uppercase tracking-widest">Consultando Meta Archive...</p>
              </motion.div>
            ) : ads.length > 0 ? (
              ...
              <EmptyState
                icon={LayoutGrid}
                title="Sua busca começa aqui"
                description="Use palavras-chave para filtrar a biblioteca de anúncios da Meta."
              />
            )}
          </AnimatePresence>
        </div>
